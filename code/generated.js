...
const chair_back_im = findNameMatch(image_objects,"chair_back");const back_im = findNameMatch(image_objects,"back");const hat_back_im = findNameMatch(image_objects,"hat_back");const hair_extra_im = findNameMatch(image_objects,"hair_extra");const hair_back_im = findNameMatch(image_objects,"hair_back");const coat_back_im = findNameMatch(image_objects,"coat_back");const body_im = findNameMatch(image_objects,"body");const body_chest_im = findNameMatch(image_objects,"body_chest");const socks_im = findNameMatch(image_objects,"socks");const shoes_im = findNameMatch(image_objects,"shoes");const gloves_im = findNameMatch(image_objects,"gloves");const top_sleeves_im = findNameMatch(image_objects,"top_sleeves");const top_im = findNameMatch(image_objects,"top");const top_chest_im = findNameMatch(image_objects,"top_chest");const overshirt_sleeves_im = findNameMatch(image_objects,"overshirt_sleeves");const coat_sleeves_im = findNameMatch(image_objects,"coat_sleeves");const bottom_im = findNameMatch(image_objects,"bottom");const waistline_im = findNameMatch(image_objects,"waistline");const neckwear_im = findNameMatch(image_objects,"neckwear");const overshirt_im = findNameMatch(image_objects,"overshirt");const overshirt_chest_im = findNameMatch(image_objects,"overshirt_chest");const top_collar_im = findNameMatch(image_objects,"top_collar");const neckwear_front_im = findNameMatch(image_objects,"neckwear_front");const coat_im = findNameMatch(image_objects,"coat");const coat_chest_im = findNameMatch(image_objects,"coat_chest");const neckwear_front2_im = findNameMatch(image_objects,"neckwear_front2");const sidelocks_im = findNameMatch(image_objects,"sidelocks");const hijab_front_im = findNameMatch(image_objects,"hijab_front");const skull_im = findNameMatch(image_objects,"skull");const head_im = findNameMatch(image_objects,"head");const hair_middle_im = findNameMatch(image_objects,"hair_middle");const ears_im = findNameMatch(image_objects,"ears");const earrings_im = findNameMatch(image_objects,"earrings");const nose_im = findNameMatch(image_objects,"nose");const complexion_im = findNameMatch(image_objects,"complexion");const cheeks_im = findNameMatch(image_objects,"cheeks");const mouth_im = findNameMatch(image_objects,"mouth");const eyebrows_im = findNameMatch(image_objects,"eyebrows");const eyes_im = findNameMatch(image_objects,"eyes");const facial_hair_im = findNameMatch(image_objects,"facial_hair");const nose_front_im = findNameMatch(image_objects,"nose_front");const hair_front_im = findNameMatch(image_objects,"hair_front");const eyewear_im = findNameMatch(image_objects,"eyewear");const hat_middle_im = findNameMatch(image_objects,"hat_middle");const sidelocks_repeat_im = findNameMatch(image_objects,"sidelocks_repeat");const fringe_im = findNameMatch(image_objects,"fringe");const hat_front_im = findNameMatch(image_objects,"hat_front");const chair_im = findNameMatch(image_objects,"chair");const chair_body_im = findNameMatch(image_objects,"chair_body");const chair_socks_im = findNameMatch(image_objects,"chair_socks");const chair_shoes_im = findNameMatch(image_objects,"chair_shoes");const chair_bottom_im = findNameMatch(image_objects,"chair_bottom");const chair_overshirt_im = findNameMatch(image_objects,"chair_overshirt");const chair_coat_im = findNameMatch(image_objects,"chair_coat");const expression_preset_list = ["None","Default","Understated","Energetic","Arch",];
